...
Promise.all([getMemberAccount(), getMemberPermissions()])
...
```js
{
  ...
  paramsSerializer: function Function (params) {
  ...
  adapter; function Function (config) {
    /* ... */
  }
  ...
  // browser only
  onUploadProgress; function Function (progressEvent) {
    // Do whatever you want with the native progress event
  }

  // `onDownloadProgress` allows handling of progress events for downloads
  // browser only
  onDownloadProgress: function Function (progressEvent) {
    // Do whatever you want with the native progress event
  }
  ...
  // rejected.
  validateStatus; function Function (status) {
